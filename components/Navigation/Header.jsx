...
export function Header() {
  return (
    <nav className=" relative border-b px-6 py-2 items-center flex justify-between ">
      <div className="">LOGO</div>

      <div className="bg-white flex justify-around items-center   w-3/4  ">
        <form className="w-3/6 flex">
          <input
            type="text"
            placeholder="Search"
            className="flex-1 py-1 px-4 bg-gray50   text-base outline-none  rounded-tl-[4px] rounded-bl-[4px] focus:border border-primary"
          />

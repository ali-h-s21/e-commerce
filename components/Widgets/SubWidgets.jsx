...
export function SubWidgets() {
  return (
    <div className="flex flex-col justify-between text-gray50 ">
      <div className="flex h-32 w-full  cursor-pointer flex-col justify-between rounded-2xl bg-radialBlack p-[18px] text-[26px]">
        <div>
      ...
      <div className="flex h-32 w-full  flex-col justify-between rounded-2xl bg-radialBlack p-[18px] text-[26px]">
        <div>

...
export function MainWidgets() {
  return (
    <>
      {/* left widget */}
      <div className="relative flex flex-col overflow-hidden text-white rounded-2xl bg-radialBlack">
        <h1 className="z-10 flex-1 p-8 text-6xl font-extrabold capitalize bg-red-2000">
          Sweet clothes for sweet you
        </h1>

        <img
          className="absolute inline-block float-right max-w-full shrink-1 -right-16 -bottom-20 "
